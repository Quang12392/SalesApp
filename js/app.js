...
const App = {
  ...
  reportFinance(el, orders, view) {
    ...
    if(view==='chart'){
      ...
      el.innerHTML=`<h2 class="report-title">Báo cáo tài chính</h2>${cards}<div class="card" style="margin-top:16px"><div class="card-header"><h3>Tổng hợp</h3></div><div class="card-body"><table class="data-table"><tbody><tr><td>Tổng doanh thu</td><td style="text-align:right;font-weight:600;color:#05e2e0">${fmtd(rev)}</td></tr><tr><td>Giá vốn hàng bán</td><td style="text-align:right;font-weight:600;color:#EF4444">${fmtd(cost)}</td></tr><tr><td>Chiết khấu</td><td style="text-align:right">${fmtd(disc)}</td></tr><tr style="font-size:1.1rem;font-weight:700;background:var(--bg-secondary)"><td>Lợi nhuận gộp</td><td style="text-align:right;color:#2E7D32">${fmtd(profit)}</td></tr><tr><td>Biên lợi nhuận</td><td style="text-align:right;font-weight:600">${rev?Math.round(profit/rev*100):0}%</td></tr></tbody></table></div></div>`;
    }
  },
  // ═════════ INVENTORY ═════════
  inventoryView: 'chart',
