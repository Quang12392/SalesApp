...
- **Bước tiếp theo:** người dùng xác nhận tài khoản Cloudflare có thể sử dụng và chọn cơ chế đăng nhập (giữ tên tài khoản hiện tại với phiên an toàn hoặc chuyển sang nhà cung cấp danh tính). Không thay cơ chế đăng nhập khi chưa chốt ảnh hưởng tới các điện thoại và Extension. Không gửi secret/mật khẩu qua chat.
