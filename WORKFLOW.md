...
- **Bước tiếp theo:** chốt cơ chế đăng nhập SalesApp (giữ tên tài khoản hiện tại với phiên an toàn hoặc dùng nhà cung cấp danh tính). Khuyến nghị về trải nghiệm là giữ tên đăng nhập hiện tại để hạn chế thay đổi thao tác trên 2–3 điện thoại, nhưng vẫn phải nâng cấp xác thực/thu hồi phiên, lưu mật khẩu an toàn và thêm đăng nhập cho Extension. Đây là đề xuất, chưa phải lựa chọn người dùng đã xác nhận; không thay cơ chế đăng nhập khi chưa chốt.
